            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.FinancialHealth"
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.CategorySpending"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "model.CategorySpending": {
            ...
            "properties": {
                ...
                "percentage": {
                    "description": "Будет вычислено в сервисе",
                    "type": "number"
                },
                "total_amount": {
                    "type": "number"
        ...
        "model.FinancialHealth": {
            ...
            "properties": {
                ...
                "monthly_trends": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.MonthlyBalanceTrend"
                    }
                },
                "total_balance": {
                    "type": "number"
        ...
        "model.MonthlyBalanceTrend": {
            ...
            "properties": {
                ...
                "month": {
                    "description": "Формат: \"Январь 2024\"",
                    "type": "string"
                }
            }
        }
